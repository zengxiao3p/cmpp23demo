...
public class TaskQueueServiceImpl extends TaskQueueService {
    ...
    public void afterTaskFinish(SumbitMessageDetail sumbitMessageDetail) throws Exception {
        ...
        overviewInfo.setId(System.currentTimeMillis());
        overviewInfo.setAvarageSpeed(Integer.parseInt(sumbitMessageDetail.getAverageGetRate()));
        overviewInfo.setCreateTime(new Timestamp(System.currentTimeMillis()));
        overviewInfo.setUpdateTime(new Timestamp(System.currentTimeMillis()));
        overviewInfo.setFailCount(Long.parseLong(sumbitMessageDetail.getFailCount()));
        overviewInfo.setMaxSpeed(Integer.valueOf(sumbitMessageDetail.getMaxSpeed()));
        overviewInfo.setMinSpeed(Integer.valueOf(sumbitMessageDetail.getMinSpeed()));
        overviewInfo.setSendCount(Long.valueOf(sumbitMessageDetail.getSendCount()));
        overviewInfo.setSuccessCount(Long.valueOf(sumbitMessageDetail.getSuccessCount()));
        overviewInfo.setSuccessRate(Double.valueOf(sumbitMessageDetail.getSuccessRate()));
//        DBUtil.insertOverviewInfos(overviewInfo);
    }
